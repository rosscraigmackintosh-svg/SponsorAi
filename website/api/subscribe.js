...
/* ── Welcome email HTML (inlined — no file system dependency) ─────────── */
...
'      .email-bg { background-image: url(\'' + SITE_URL + '/images/email-mob.png\') !important; }' +
'    }' +
'  </style>' +
'</head>' +
...
'    style="background-color: #08080e; background-image: url(\'' + SITE_URL + '/images/email.png\'); background-size: cover; background-position: center top; background-repeat: no-repeat;">' +
'    <tr>' +
'      <td align="center"' +
'        style="background-color: rgba(8,8,14,0.72); background-image: linear-gradient(to bottom, rgba(8,8,14,0.55) 0%, rgba(8,8,14,0.70) 60%, rgba(8,8,14,0.92) 100%);">' +
...
'                <tr>' +
'                  <td>' +
'                    <img src="' + SITE_URL + '/images/logo-whitepng.png" alt="SponsorAI" height="20" style="display:block; border:0; outline:none; text-decoration:none;">' +
'                  </td>' +
'                  <td align="right">' +
'                    <span style="font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 1.4px; text-transform: uppercase; color: rgba(255,255,255,0.40); border: 1px solid rgba(255,255,255,0.18); padding: 5px 12px; border-radius: 100px;">Early Access</span>' +
'                  </td>' +
'                </tr>' +
'              </table>' +
'            </td>' +
'          </tr>' +
'          <tr>' +
'            <td style="padding: 0 0 52px 0; border-top: 1px solid rgba(255,255,255,0.10); font-size: 0; line-height: 0;"></td>' +
'          </tr>' +
'          <tr>' +
...
'          </tr>' +
'          <tr>' +
'            <td style="padding: 0 0 40px 0; border-top: 1px solid rgba(255,255,255,0.08); font-size: 0; line-height: 0;"></td>' +
'          </tr>' +
'          <tr>' +
'            <td class="content-pad" style="padding: 0 0 52px 0;">' +
...
'              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">' +
'                <tr>' +
'                  <td width="16" valign="top" style="padding-top: 2px; color: rgba(255,255,255,0.20); font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 14px;">&#8211;</td>' +
'                  <td style="padding: 0 0 14px 10px; font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 14px; font-weight: 300; line-height: 1.7; color: rgba(255,255,255,0.52);">' +
'                    We\'ll email you when we have a confirmed release date.' +
'                  </td>' +
'                </tr>' +
'                <tr>' +
'                  <td width="16" valign="top" style="padding-top: 2px; color: rgba(255,255,255,0.20); font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 14px;">&#8211;</td>' +
'                  <td style="padding: 0 0 14px 10px; font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 14px; font-weight: 300; line-height: 1.7; color: rgba(255,255,255,0.52);">' +
'                    Early access will be limited. Being on this list puts you ahead of the queue.' +
'                  </td>' +
'                </tr>' +
'                <tr>' +
'                  <td width="16" valign="top" style="padding-top: 2px; color: rgba(255,255,255,0.20); font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 14px;">&#8211;</td>' +
'                  <td style="padding: 0 0 0 10px; font-family: -apple-system, BlinkMacSystemFont, \'Helvetica Neue\', Arial, sans-serif; font-size: 14px; font-weight: 300; line-height: 1.7; color: rgba(255,255,255,0.52);">' +
'                    We won\'t send noise. If you hear from us, it\'s worth reading.' +
'                  </td>' +
'                </tr>' +
'              </table>' +
'            </td>' +
'          </tr>' +
'          <tr>' +
'            <td style="padding: 0 0 32px 0; border-top: 1px solid rgba(255,255,255,0.08); font-size: 0; line-height: 0;"></td>' +
'          </tr>' +
'          <tr>' +
...
'                &nbsp;<a href="' + SITE_URL + '" style="color: rgba(255,255,255,0.28); text-decoration: underline;">Unsubscribe</a>' +
'              </p>' +
'            </td>' +
'          </tr>' +
'        </table>' +
